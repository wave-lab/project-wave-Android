...
class LibraryLikeFragment : Fragment() {
    ...
    fun insertData(v : View){
        ...
        v.recycler_library_like_frag_list.adapter = PlaylistAdapter(songDataArr, requestManager)
        v.recycler_library_like_frag_list.layoutManager = LinearLayoutManager(v.context)
    }
}