...
class RecomentSongHomeAdapter(private var homeSongData: ArrayList<HomeSongData>, var requestManager : RequestManager) : RecyclerView.Adapter<HomeSongViewHolder>(){
