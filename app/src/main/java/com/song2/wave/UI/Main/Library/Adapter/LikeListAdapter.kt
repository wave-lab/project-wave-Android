...
class LikeListAdapter (var context : Context, private var songData : ArrayList<SongData>, var requestManager : RequestManager) : RecyclerView.Adapter<SongSearchViewHolder>(){
    ...
    override fun onBindViewHolder(holder: SongSearchViewHolder, position: Int) {
        ...
        // ex)
        Log.v("Asdf","결과 = " + songData[position].songCoverImg)
        requestManager.load(songData[position].songCoverImg).into(holder.songCoverImg)
